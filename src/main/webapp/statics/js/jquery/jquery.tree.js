...
hit.removeClass("tree-collapsed icon-collapsed tree-collapsed-hover").addClass("tree-expanded icon-expanded");
...
hit.removeClass("tree-expanded icon-expanded tree-expanded-hover").addClass("tree-collapsed icon-collapsed");
...
var hit=$("<span class=\"tree-hit tree-expanded iconfont icon-expanded\"></span>").insertBefore(_a0);
if(hit.prev().length){
hit.prev().remove();
}
}
...
cc.push("<span class=\"tree-hit tree-collapsed iconfont icon-collapsed\"></span>");
cc.push("<span class=\"tree-icon tree-folder "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
if(item.children&&item.children.length){
cc.push("<span class=\"tree-hit tree-expanded iconfont icon-expanded\"></span>");
