...
public interface PromotionStrategyService {
     ...
     * 新增
     */
    PromotionStrategy insert(PromotionStrategy model);

    /**
     * 新增
     */
    PromotionStrategy insert(PromotionStrategy model, LocalUser currentUser);
     ...
     * 更新
     */
    PromotionStrategy update(PromotionStrategy model, LocalUser currentUser);
    ...
    Integer updateStateByIds(String modelIds, Integer state);
}