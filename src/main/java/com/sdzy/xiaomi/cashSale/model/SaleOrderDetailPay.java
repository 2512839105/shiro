package com.sdzy.xiaomi.cashSale.model;
...
import com.asdzy.purpleredgourd.promotion.model.PromotionGiveProduct;
import com.asdzy.purpleredgourd.promotion.model.PromotionProduct;
 ...
 * @author  charlin
 */
public class SaleOrderDetailPay implements Comparable<SaleOrderDetailPay>, Serializable{
	...
	@Override
    public int compareTo(SaleOrderDetailPay o) {
